...
const Header = ({ setViewPort }: SectionWithViewportProps) => {
  ...
  const handleNavigation = (path: string, ref: ViewportKey | null = null) => {
  ...
  return (
    <div
      className={`w-full flex justify-center mx-auto px-10 py-4 z-40
