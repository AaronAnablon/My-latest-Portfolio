...
const About = forwardRef<HTMLDivElement, SectionWithViewportProps>(({ title }, ref) => {
  const images = [
    ...
    <div ref={ref}>
      <div className="h-max mt-32 mb-32 flex flex-col align-center justify-center">
        <div className='grid gap-32 relative justify-center'>
          <Image className='absolute brightness-200 top-0 -right-52' src={'/testimonials/Ellipse.svg'} width={700} height={700} alt='about' />
          <Image className='absolute brightness-50 z-10 -top-10 -right-52 scale-y-[-1]' src={'/testimonials/Polygon_right.svg'} width={400} height={300} alt='about' />
          <div className='rounded-[1.5rem] backdrop-contrast-50 bg-[#292932] grid lg:grid-cols-2 grid-cols-1 items-center lg:mx-32 mx-2 md:mx-48 py-16 lg:py-24 px-6 lg:px-8 gap-10'>
            <Image className='mx-auto md:w-full w-64' src={'/assets/profile.webp'} width={600} height={600} alt='Profile portrait' />
            <div className='grid justify-start lg:mx-14 mx-0 gap-10'>
              ...
              <p>I craft well-structured, maintainable code and develop applications that bridge the gap between business needs and technical execution. I enjoy taking raw ideas, refining them, and turning them into reliable, production-ready web applications!</p>
            </div>
          </div>
          <div>
          ...
          <div className='relative flex items-center justify-center'>
            <Image className='absolute -top-56 w-32 lg:w-max right-14' src={'/testimonials/Dots.svg'} width={140} height={100} alt='about' />
            <Image className='absolute -top-16 lg:w-max w-44 left-0 z-10' src={'/subscribe/Polygon_left.svg'} width={650} height={500} alt='about' />
            <div className='grid grid-cols-1 lg:grid-cols-2 mx-10 md:mx-44 lg:mx-20 gap-8 items-center rounded-[1.5rem] p-6 backdrop-brightness-50 bg-[#1d1d27]'>
              ...
              <Image className='z-50' src={'/mission/Mission.png'} width={1300} height={1300} alt='Mission illustration' />
            </div>
          </div>
        </div>
      </div>
