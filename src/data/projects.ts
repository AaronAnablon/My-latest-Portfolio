export const projectsData = [
    {
        title: 'RecoDocument',
        url: 'https://recodocument.nolbana.com/',
        image: '/projects/recodocument.png',
        description: 'BIR-aware OCR platform for accounting teams. Turn a stack of receipts into filed, organized records automatically with AI-powered document scanning, tax extraction, and multi-business management built for Philippine bookkeeping.',
        tags: ['OCR', 'Machine Learning', 'Tax Processing', 'Document Automation'],
    },
    {
