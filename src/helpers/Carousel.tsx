...
const Carousel = ({ images }: CarouselProps) => {
  ...
  return (
    <div className='relative bg-gray-800 rounded-xl py-6 px-14'>
      ...
      <button className='absolute left-2 top-1/2 transform -translate-y-1/2' onClick={prevSlide} type='button'>
        <GrPrevious size={32} className='bg-gray-800 border-2 border-white text-white rounded-full p-1' />
      </button>
      <button className='absolute right-2 top-1/2 transform z-50 -translate-y-1/2' onClick={nextSlide} type='button'>
